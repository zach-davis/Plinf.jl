(define (domain kitchen)
    ...
    (:action fry
    :parameters (?p - pan ?i - ingredient ?dir - direction)
    :precondition (and (has ?p)
                       (oven (+ xpos (xdiff ?dir)) (+ ypos (ydiff ?dir))))
    ; we want the ingredient to have the property of being fried
    :effect ()
    )
    (:action up
